...
func Example() {
	// No matter how many goroutines call Do, only one call per key will ever
	// execute. Callers that share a key will get the same results as an
	// in-flight call with that key.
	n := int32(41)
